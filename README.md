...
- Now it uses a remote binaryTarget URL (with checksum). No script changes are required if you use standard SPM resolution,but your build environment must be able to access [https://mxrepo.moxo.com/repository/customer-maven-releases](https://mxrepo.moxo.com/repository/customer-maven-releases) to download the zip.
